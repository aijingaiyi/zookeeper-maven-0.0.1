...
public class QuorumPacket implements Record {
  ...
  private long zxid;
  private byte[] data;
  private java.util.ArrayList authinfo;
  public QuorumPacket() {
  }
  public QuorumPacket(
        int type,
  ...
  public java.util.ArrayList getAuthinfo() {
    return authinfo;
  }
  public void setAuthinfo(java.util.ArrayList m_) {
    authinfo=m_;
  }
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    ...
    data=a_.readBuffer("data");
    {
      ...
      if (vidx1!= null) {          authinfo=new java.util.ArrayList();
